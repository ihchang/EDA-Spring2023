---
title: "IreneChang_A10_DataScraping"
author: "Irene Chang"
output: pdf_document
...
df.withdrawals <-
  data.frame("Month" = c(1, 5, 9, 2, 6, 10, 3, 7, 11, 4, 8, 12),
             "Year" = rep(2022,12),
             "Max_Withdrawal_MGD" = as.numeric(max.withdrawals.mgd)) %>% 
...
>ANSWER: In general, it looks like over time, the maximum withdrawl (MGD) has steadily increased starting from around 2015. From 2010-2015, maximum withdrawal was on a slight decline.
