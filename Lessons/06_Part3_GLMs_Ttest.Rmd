...
O3.onesample #rejecting the null and accepting the alternative, so we know that the mean is less than 50.
...
#we are now asking is year a predictor of ozone levels?
```
