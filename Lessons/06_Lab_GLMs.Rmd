...
summary(Ozone.best) #the more variables you have in your model, the more complex it becomes. so you only add them if its going to help your model. The more variables you have, the better they will be, the adjusted will put some penalty for having that extra variable
```
