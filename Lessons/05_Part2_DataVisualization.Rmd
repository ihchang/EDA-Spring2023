...
O3plot1 <- ggplot(EPAair) +
  geom_point(aes(x = Date, y = Ozone)) +
  theme_gray() #default for gg plot
print(O3plot1)
...
```{r, fig.height = 3, fig.width = 4, warning = FALSE}
mytheme <- theme_classic(base_size = 14) + #want the font to be size 14
  theme(axis.text = element_text(color = "black"), #want the axes labels to be black
...
NvsP2 <-
  ...
  scale_shape_manual(values = c(15, 17)) + #youre changing the shape
