...
#we have year that will tell you what year it will be recorded, so you can choose how to filter, she will tell us how many rows the filtered data should have
...
#if we are doing things within a pipe, then you dont need to use the first R command because function filter knows to use that data set. you also dont need to assign it for each step of the way.
...
#you want to make it wider, so when you create a wider data frame, each element in the depth will become a column name and you are taking the values from temperature
#31k observations
